...
- [Whole-domain mailbox connects](/development/whole-domain-connect/): the Google service account and Microsoft app that let a workspace connect a whole Google Workspace domain or Microsoft 365 organization
