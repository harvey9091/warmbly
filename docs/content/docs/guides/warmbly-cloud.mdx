...
|------|-----------|----------|
| Free | Up to 10 per linked workspace | The pool's free tier only. A free mailbox mails a paid one solely to answer a thread that paid mailbox started |
| Premium (the Warmup plan, $15 a month or $144 a year) | Unlimited | The premium tier first; up to 25 proven free mailboxes fill in only when the premium tier runs thin |

Premium workspaces are always served first. Borrowed partners are limited to mailboxes that have been healthy pool members for at least three days in a workspace in good standing, so nothing unproven ever reaches a paying mailbox.
